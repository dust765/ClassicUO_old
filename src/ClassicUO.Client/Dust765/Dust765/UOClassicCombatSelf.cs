    ...
    internal class UOClassicCombatSelf : Gump
    {
        ...
        */
        ...
        public UOClassicCombatSelf() : base(0, 0)
        {
            ...
            Add
            (
                _uiIconAutoBandage = new StaticPic(0x0E21, 0)//bandies
                {
                    X = -13, 
                    Y = 24,
            ...
            Add
            (
                _uiIconAutoPouche = new StaticPic(0x0E79, 0x0026)//pouch
                {
                    X = -17, 
                    Y = 43,
                    AcceptMouseInput = false
            ...
            Add
            (
                _uiIconAutoCurepot = new StaticPic(0x0F07, 0)//curepot
                {
                    X = -8, 
                    Y = 62,
                    AcceptMouseInput = false
            ...
            Add
            (
                _uiIconAutoHealpot = new StaticPic(0x0F0C, 0)//healpot
                {
                    X = -8, 
                    Y = 81,
                    AcceptMouseInput = false
            ...
            Add
            (
                _uiIconAutoRefreshpot = new StaticPic(0xF0B, 0)//refreshpot
                {
                    X = -8, 
                    Y = 100,
                    AcceptMouseInput = false
            ...
            Add
            (
                _uiIconAutoEApple = new StaticPic(0x2fd8, 0x0488)//apple
                {
                    X = -14, 
                    Y = 122,
                    AcceptMouseInput = false
            ...
            Add
            (
                _uiIconStrengthpot = new StaticPic(0xF09, 0)//strength
                {
                    X = -8, 
                    Y = 139,
                    AcceptMouseInput = false
            ...
            Add
            (
                _uiIconDexpot = new StaticPic(0xF08, 0)//agility
                {
                    X = -8, 
                    Y = 158,
                    AcceptMouseInput = false
            ...
            Add
            (
                _uiIconAutoRearmAfterDisarmed = new StaticPic(0x0BC0, 0)//armourer
                {
                    X = -11, 
                    Y = 218,
                    AcceptMouseInput = false
            ...
            Add
            (
                _uiIconConsiderHidden = new StaticPic(0x0C00, 0)//assasins guild
                {
                    X = -11, 
                    Y = 242,
                    AcceptMouseInput = false
            ...
            Add
            (
                _uiIconConsiderSpells = new StaticPic(0x0BAD, 0)//mage shop
                {
                    X = -11, 
                    Y = 273,
                    AcceptMouseInput = false
        ...
        public override void Update()
        {
            ...
            //FAILSAFES
            if ((Time.Ticks - _tickStartAutoBandage) > 10000 && _tickStartAutoBandage != 0)
            {
        ...
        private void UpdateCounters()
        {
            ...
            */
            if (_useBandiesTime)
            {
                ...
                if (_timerAutoBandage > 10) //FAILSAFE
                    ClilocTriggerStopBandies();
